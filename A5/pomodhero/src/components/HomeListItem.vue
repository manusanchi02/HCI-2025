    ...
    <div
        ...
        <div :class="['self-stretch pl-3.5 pr-2.5 rounded-3xl flex justify-center items-center overflow-hidden', isToday ? 'bg-amber-400' : 'bg-white']">
            <div class="px-2.5 inline-flex flex-col justify-start items-start overflow-hidden">
                <div class="h-6 justify-start text-emerald-950 text-2xl font-normal font-['Roboto'] italic mb-0.5">
                    Pranzo</div>
                ...
                <div :class="['justify-start text-sm font-normal font-[\'Roboto\'] italic -mt-1.5',  isToday ? 'text-emerald-900' : 'text-gray-500']">{{ lunchIngredientsCount }} {{ lunchIngredientsLabel }}
                </div>
            </div>
            <div class="px-2.5 inline-flex flex-col justify-start items-start overflow-hidden">
                <div class="h-6 justify-start text-emerald-950 text-2xl font-normal font-['Roboto'] italic mb-0.5">
                ...
                <div :class="['justify-start text-sm font-normal font-[\'Roboto\'] italic -mt-1.5',  isToday ? 'text-emerald-900' : 'text-gray-500']">{{ dinnerIngredientsCount }} {{ dinnerIngredientsLabel }}
                </div>
            </div>
