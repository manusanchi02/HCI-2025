...
chiaramente questo è un prototipo quindi ci sono alcune funzionalità che non funzionano come dovrebbero.

chiaramente si tratta di un test, ma a essere testata è l'applicazione, non tu, quindi qualsiasi difficoltà o errore che potresti incontrare durante lo svolgimento dei task è totalmente colpa dell'applicazione e non tua! sentiti assolutamente libero di giudicare e non avere paura di sbagliare.

per questo test useremo la metodologia think-aloud quindi quello che ti chiediamo di fare è una cosa un po' strana ma molto utile: praticamente mentre tu stai svolgendo i task dovrai descriverci a parole i tuoi pensieri, ovvero quello che stai facendo, quello che secondo te sta succedendo all'interno dell'applicazione, quali sono le tue le tue sensazioni o reazioni durante l'utilizzo o se ci sono ad esempio cose che ti piacciono o cose che non ti piacciono.

non è una cosa molto naturale da fare quindi non preoccuparti se inizialmente ti può sembrare un po' strana, sappi che per noi è estremamente utile perché possiamo ottenere in questo modo un sacco di informazioni riguardo il processo mentale che gli utenti hanno nell'utilizzo dell'app.

in ogni momento comunque se sei confuso, o se hai qualche domanda puoi chiedere tranquillamente a me.
...
task 2.
immagina: ora che hai programmato per bene le ricette da preparare, improvvisamente vieni invitato dai tuoi amici a mangiare fuori, ma tu hai già comprato tutti gli ingredienti necessari per la tua ricetta. Utilizza l'app per gestire questo imprevisto e riciclare tutti gli ingredienti nel piano delle ricette dei giorni successivi.
